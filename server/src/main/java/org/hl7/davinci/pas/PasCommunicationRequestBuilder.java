...
public final class PasCommunicationRequestBuilder {
   ...
   * itself is named by the item trace number on the matching ClaimResponse.item.
   */
  public static CommunicationRequest buildQuestionnaireRequest(int lineNumber, String patientRef) {
    CommunicationRequest request = base(lineNumber, patientRef);
  ...
  private static CommunicationRequest base(int lineNumber, String patientRef) {
